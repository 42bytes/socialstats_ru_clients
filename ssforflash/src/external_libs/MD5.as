package external_libs {
  public class MD5 {
      ...
      private static function RotateLeft(lValue : uint, iShiftBits : uint) : uint {
          return (lValue<<iShiftBits) | (lValue>>>(32-iShiftBits));
      }

      private static function AddUnsigned(lX : uint,lY : uint) : uint {
          var lX4 : uint,lY4 : uint,lX8 : uint,lY8 : uint,lResult : uint;
          lX8 = (lX & 0x80000000);
          lY8 = (lY & 0x80000000);
          lX4 = (lX & 0x40000000);
          lY4 = (lY & 0x40000000);
      ...
      private static function ConvertToWordArray(string : String) : Array {
          var lWordCount : uint;
          var lMessageLength : uint = string.length;
          var lNumberOfWords_temp1 : uint = lMessageLength + 8;
          var lNumberOfWords_temp2 : uint = (lNumberOfWords_temp1-(lNumberOfWords_temp1 % 64))/64;
          var lNumberOfWords : uint = (lNumberOfWords_temp2+1)*16;
          var lWordArray : Array = new Array(lNumberOfWords-1);
          var lBytePosition : uint = 0;
          var lByteCount : uint = 0;
      ...
      private static function WordToHex(lValue : uint) : String {
          var WordToHexValue : String = "", WordToHexValue_temp : String = "", lByte : uint, lCount : uint;
